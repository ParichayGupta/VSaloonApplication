...
public class OverFlyingRecyclerViewLayoutManager extends RecyclerView.LayoutManager
    ...
    /* package */public OnPageChangeListener onPageChangeListener;
     ...
     */
    public OverFlyingRecyclerViewLayoutManager(Context context) {
     ...
     */
    public OverFlyingRecyclerViewLayoutManager(int orientation, boolean reverseLayout) {
    ...
    public OverFlyingRecyclerViewLayoutManager(float minScale, int itemSpace, int orientation) {
    ...
    public int onPageChangeListener(OnPageChangeListener onPageChangeListener) {
        return 0;
    }
